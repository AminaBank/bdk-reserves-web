...
use bdk::bitcoin::{OutPoint, Script, TxOut};
use bdk::electrum_client::{Client, ElectrumApi};
use bdk::{bitcoin::Address, blockchain::Capability};
use bdk::{
    database::BatchDatabase, wallet::AddressIndex, Error as BdkError, FeeRate, KeychainKind, Wallet,
};
...
async fn check_proof(item: web::Json<ProofOfReserves>, req: HttpRequest) -> HttpResponse {
    ...
    let server = "ssl://electrum.blockstream.info:60002";
    let proof_result = handle_ext_reserves(
        Network::Testnet,
        &item.message,
        &item.proof_psbt,
        3,
        vec![item.address.clone()],
        server,
    );
    ...
    async fn test_index() -> Result<(), Error> {
        ...
        let req = test::TestRequest::post()
            ...
            .set_json(&ProofOfReserves {
                address: "2Mtkk3kjyN8hgdGXPuJCNnwS3BBY4K2frhY".to_owned(),
